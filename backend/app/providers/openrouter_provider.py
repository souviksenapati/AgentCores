...
from app.core.interfaces import (
    AIProviderInterface, AgentConfig, TaskResult, TaskStatus, ProviderType
)
import logging
import os
...
class OpenRouterProvider(AIProviderInterface):
    ...
    async def generate_completion(
        ...
        try:
            ...
            logger.info(f"OpenRouter completion successful: {task_id}, "
    ...
    async def validate_config(self, config: AgentConfig) -> bool:
        ...
        try:
            ...
            if config.model not in self.model_pricing:
                logger.warning(f"Model {config.model} not in pricing table, proceeding anyway")
            ...
            if config.max_tokens <= 0 or config.max_tokens > 32000:
                raise ValueError(f"max_tokens must be between 1 and 32000, got {config.max_tokens}")
    ...
    def get_model_info(self, model: str) -> Dict[str, Any]:
        ...
        model_specific = {
            "anthropic/claude-3-haiku": {
                ...
                "use_cases": ["customer service", "content moderation", "data extraction"]
            },
            ...
            "anthropic/claude-3-opus": {
                ...
                "use_cases": ["advanced reasoning", "creative writing", "complex analysis"]
            },
            "openai/gpt-4": {
                "context_length": 8192,
            ...
            "openai/gpt-4-turbo": {
                ...
                "use_cases": ["document analysis", "long conversations", "complex tasks"]
            }
        }
