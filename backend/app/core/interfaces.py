...
class AgentServiceInterface(ABC):
    ...
    @abstractmethod
    async def get_agent_analytics(self, agent_id: str, tenant_id: str) -> Dict[str, Any]:
...
class ProviderRegistry:
    ...
    def register_provider(self, provider_type: ProviderType, provider: AIProviderInterface):
