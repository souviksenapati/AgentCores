...
def upgrade():
    ...
    op.add_column('agents', sa.Column('model', sa.String(200), default='openrouter/meta-llama/llama-3.2-3b-instruct:free'))
    op.add_column('agents', sa.Column('instructions', sa.Text(), default='You are a helpful AI assistant.'))
    ...
    op.create_index('ix_chat_messages_agent_created', 'chat_messages', ['agent_id', 'created_at'])
    op.create_index('ix_chat_messages_tenant_agent', 'chat_messages', ['tenant_id', 'agent_id'])
